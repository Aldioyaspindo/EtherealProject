...
export default function ArticleCard({ item }) {
  ...
  const excerpt = item.IsiArtikel ? item.IsiArtikel.slice(0, 80) : "Tidak ada deskripsi singkat.";
  ...
  return (
    ...
    >
      ...
      <div className="w-full h-[180px] sm:h-[220px] md:h-[250px] overflow-hidden">
        <img
          src={item.ImageUrl || "https://placehold.co/600x400/D1D5DB/1F2937?text=No+Image"}
          alt={title}
